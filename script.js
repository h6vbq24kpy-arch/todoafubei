...
const smBtn = document.getElementById("sm");
const compBtn = document.getElementById("complite");
const notcompBtn = document.getElementById("notcomplite");
...
smBtn.addEventListener("click", () => {
  window.location.href = "https://youtu.be/vc_UVpFayaw?si=URs_ZXN7uXOCbNta";
})
...
//Defeatボタンを押したとき
notcompBtn.addEventListener("click", () => {
  window.location.href = "https://youtu.be/L4J5pxu48v8?si=6pWIl6txLrjRnpAK"
})
